...
export default function ConnexionPage() {
  return (
    <Suspense fallback={<div className="flex min-h-[calc(100vh-200px)] items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-primary" /></div>}>
      <ConnexionContent />
    </Suspense>
  );
}
...
function ConnexionContent() {
  ...
  useEffect(() => {
    ...
    if (error === "google_cancelled") {
      ...
      setErrors({ general: "La connexion Google n'est pas encore configurée" });
        ...
        <div className="rounded-2xl bg-white p-8 shadow-lg">
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-200 bg-white py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-60"
            >
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/inscription" className="font-semibold text-primary hover:text-primary-dark">
              Créer un compte
            </Link>
          </p>
        </div>
